package com.anshuman.ms.VaccinationCenter.controller;
...
import com.anshuman.ms.VaccinationCenter.external.CitizenServiceClient;
import com.anshuman.ms.VaccinationCenter.model.Citizen;
import com.anshuman.ms.VaccinationCenter.model.RequiredResponse;
import com.anshuman.ms.VaccinationCenter.repo.CenterRepo;
...
//	private RestTemplate restTemplate;
	...
	public ResponseEntity<RequiredResponse> getAllDadaBasedonCenterId(@PathVariable Integer id){
		...
		List<Citizen> listOfCitizens = citizenServiceClient.getCitizensById(id);
